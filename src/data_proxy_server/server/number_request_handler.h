...
// Last modify: 2012-09-19 15:51:29.
// File name: number_request_handler.h
//
// Description: 
// Define class NumberRequestHandler.
//

#ifndef _squirrel_dataproxy_server__NUMBER__REQUEST__HANDLER__H
#define _squirrel_dataproxy_server__NUMBER__REQUEST__HANDLER__H
...
class NumberRequestHandler : public core::Noncopyable {
 public:
 ...
 private:
  void OnRequestIncrease(const common::AsyncRequestObject *object,
      const std::string &increment);
  void OnRequestDecrease(const common::AsyncRequestObject *object,
...
#endif  // _squirrel_dataproxy_server__NUMBER__REQUEST__HANDLER__H
