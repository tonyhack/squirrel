...
struct ListRequest {
  ...
  2 : optional binary data_,                    // element(when LIST_REQUEST_TYPE_PUSH, LIST_REQUEST_TYPE_REMOVE).
}

struct ListResponse {
  1 : required ListRequestType request_type_,
  2 : required ListResponseType result_,        // enum ListResponseType.
  3 : optional binary data_,                    // element(when LIST_REQUEST_TYPE_POP).
}
