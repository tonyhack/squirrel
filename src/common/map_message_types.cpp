...
const char* MapResponse::ascii_fingerprint = "19AAB18E981C4EB11AEBB34F40FF0939";
const uint8_t MapResponse::binary_fingerprint[16] = {0x19,0xAA,0xB1,0x8E,0x98,0x1C,0x4E,0xB1,0x1A,0xEB,0xB3,0x4F,0x40,0xFF,0x09,0x39};
    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->type_ = (MapRequestType::type)ecast1;
          isset_type_ = true;
        } else {
          xfer += iprot->skip(ftype);
        }
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->result_ = (MapResponseType::type)ecast2;
          isset_result_ = true;
        } else {
          xfer += iprot->skip(ftype);
        }
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->sort_type_ = (MapSortType::type)ecast4;
          isset_sort_type_ = true;
        } else {
          xfer += iprot->skip(ftype);
        }
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            this->elements_.resize(_size5);
            uint32_t _i9;
            for (_i9 = 0; _i9 < _size5; ++_i9)
            {
              xfer += this->elements_[_i9].read(iprot);
            }
            iprot->readListEnd();
          }
          isset_elements_ = true;
...
uint32_t MapQueryRankingRangeResponse::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("elements_", ::apache::thrift::protocol::T_LIST, 1);
  {
    ...
    std::vector<MapQueryRankingRangeInfo> ::const_iterator _iter10;
    for (_iter10 = this->elements_.begin(); _iter10 != this->elements_.end(); ++_iter10)
    {
